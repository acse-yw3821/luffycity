...
class Course(BaseModel):
    ...
    course_cover = StdImageField(variations={
        ...
        null=True)
    course_video = RichTextUploadingField(max_length=255, verbose_name="封面视频", blank=True,
                                          null=True)
    course_type = models.SmallIntegerField(choices=level_choices, default=1, verbose_name="难度等级")
    ...
    attachment_path = RichTextUploadingField(max_length=1000, blank=True, null=True, verbose_name="课件路径")
    ...
    def course_cover_small(self):
        if self.course_cover:
            return mark_safe(f'<img style="border-radius: 9%;" src="{self.course_cover.thumb_108x61.url}">')
        return ""
...
class CourseLesson(BaseModel):
    ...
    lesson_link = models.CharField(max_length=255, blank=True, null=True,
                                   ...
                                   verbose_name="课时链接")
    duration = models.CharField(blank=True, null=True, max_length=32, verbose_name="课时时长")  # 仅在前端展示
