...
SECRET_KEY = 'django-insecure-mgfuq*a=mwg*8inro^&+c2ub1dg8yf!n4)wb9+*i6re94ws840'
...
# 任务队列
CELERY_BROKER_URL = 'redis://:AlwaysDay1@127.0.0.1:6379/14'
# 结果队列
CELERY_RESULT_BACKEND = 'redis://:AlwaysDay1@127.0.0.1:6379/15'
# 时区，与django的时区同步
